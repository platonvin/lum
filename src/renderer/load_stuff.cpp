...
// println
    ...
    mesh->triangles.vertexes = create_elemBuffers<PackedVoxelCircuit>(circ_verts.data(), circ_verts.size(), VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT);
// println
